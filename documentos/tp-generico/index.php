...
<meta name="Description" content="TPs en LaTeX">
...
<!-- Beg StatBar -->
 ...
 &nbsp;:: Monday 30, April 2007 - Argentina ::
 </td>
...
<!-- FIN $Id: default-cabecera.php,v 1.9 2007-03-06 11:50:54 des Exp $ -->
        <P>
	Acá podés encontrar información acerca de cómo crear un informe 
	para la facu en LaTeX. Por ahora podés bajar un documento
	a modo de ejemplo, donde podés ver cómo hacer los elementos más
	comunes (carátula, tablas, figuras, etc) de cualquier informe:
	</P>
        <A href="tp-generico.pdf">PDF</A> |
        <A href="tp-generico.tar.gz">Código fuente</A>
	<P>
	Más adelante es posible que hagamos una clase o un paquete LaTeX, que
	facilite todas estas tareas. 
	</P>
