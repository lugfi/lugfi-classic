...
<title>::: Noticias del LUGFI :::</title>
...
<meta name="Description" content="Noticias y novedades relacionadas con el LUGFI">
<link rel="shortcut icon" href="../favicon.ico">
...
<!-- Beg StatBar -->
 ...
 &nbsp;:: miércoles 01, septiembre 2004 - Argentina ::
 </td>

 <td width="44%" class="LugFI-StatBar-Center">
 :: Cuando todo falle, fijate si está enchufado.
 ::
 </td>
...
&nbsp;
<span style="MenuSection">»</span>
<a class="Menu" href="./">Noticias del LugFi
</a>
</td></tr>
...
&nbsp;
<span style="MenuSection">»</span>
<a class="Menu" href="./viejas/">Noticias viejas</a>
</td></tr>
...
&nbsp;
<span style="MenuSection">»</span>
<a class="Menu" href="./rss/">Rss-Feed <img src="/noticias/rss/xml.png" border="0" alt="XML"/> 
</a>
</td></tr>
...
<span class="LugFI-Span_Titulo">:: Agregar Noticia ::</span>
<br>
<!-- FIN $Id: default-titulo.php,v 1.2 2004/04/28 04:09:24 emiliano Exp $ -->
<center><form action="/noticias/noticia-subir.php" method="POST" enctype="application/x-www-form-urlencoded"><table class="cuerpo"><input type="hidden" name="form[]" value="Wed 01 Sep 2004"><input type="hidden" name="form[]" value="06:58"><tr><td align="right">Autor : </td><td><input type="text" name="form[]" size="60" value=""></td></tr><tr><td align="right">Título : </td><td><input type="text" name="form[]" size="60" value=""></td></tr><tr><td colspan="2" valign="top">Cuerpo : <br><textarea name="form[]" rows="10" cols="60"></textarea></td></tr><input type="hidden" name="action" value="guardar"><tr><td colspan="2" align="center"><input type="submit" value="Guardar"></td></tr></table></form></center><!-- INICIO $Id: default-pie.php,v 1.2 2004/04/28 04:09:24 emiliano Exp $ -->
...
<DIV CLASS="epigrafe" ALIGN="center">
    Última actualización: lun 19 jul 2004 03:14:35 ART</DIV>
